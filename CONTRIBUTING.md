...
Bolt combines the capabilities of AI with sandboxed development environments to create a collaborative experience where code can be developed by the assistant and the programmer together. Bolt combines [WebContainer API](https://webcontainers.io/api) with [Google Gemini](https://ai.google.dev/) using [Remix](https://remix.run/) and the [AI SDK](https://sdk.vercel.ai/).
...
models. At this time, Bolt supports using Google's Gemini model.
You can get an API key from the [Google AI Studio](https://makersuite.google.com/app/apikey) to use with Bolt.
